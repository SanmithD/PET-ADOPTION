...
import React, { useEffect, useState } from 'react';
  ...
  function ManagePets() {
    ...
    const getAllPets = async () => {
      try {
        setLoading(true);
        const response = await axios.get(`https://pet-adoption-yc64.onrender.com/api/pet/getAllPet`);
    ...
    const handlePost = async (e) => {
      ...
      try {
        await axios.post(`https://pet-adoption-yc64.onrender.com/api/pet/postPet`, formData, {
          headers: {
    ...
    //   }
      ...
      try {
        await axios.put(`https://pet-adoption-yc64.onrender.com/api/pet/updatePet/${editPet._id}`, formData, {
          headers: {
            'Content-Type': 'multipart/form-data',
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
    ...
    const handleDelete = async (id) => {
      ...
      try {
        await axios.delete(`https://pet-adoption-yc64.onrender.com/api/pet/deletePet/${id}`, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem('token')}`,
          },
        });
