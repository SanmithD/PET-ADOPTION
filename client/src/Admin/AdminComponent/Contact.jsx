...
const ContactPage = () => {
  ...
  useEffect(() => {
    const getAllMessages = async () => {
      try {
        setLoading(true);
        const response = await axios.get(`https://pet-adoption-5.onrender.com/api/contact/getAllMsg`);
  ...
  const handleReply = async (e, messageId) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://pet-adoption-5.onrender.com/api/contact/messages/${messageId}/replies`,
        { message: reply },
  ...
  const handleDelete = async (id) => {
    try {
      setLoading(true);
      await axios.delete(`https://pet-adoption-5.onrender.com/api/contact/deleteMsg/${id}`);
