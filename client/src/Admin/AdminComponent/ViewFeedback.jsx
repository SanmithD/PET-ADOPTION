...
function ViewFeedback() {
  ...
  const getAllFeedbacks = async () => {
    ...
    setError('');
    try {
      const response = await axios.get(`https://pet-adoption-yc64.onrender.com/api/feedback/getAllFeedbacks`);
  ...
  const handleDelete = async (id) => {
    setLoading(true);
    try {
      await axios.delete(`https://pet-adoption-yc64.onrender.com/api/feedback/deleteSingleFeedback/${id}`);
