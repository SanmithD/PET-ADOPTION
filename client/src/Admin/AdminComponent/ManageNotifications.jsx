...
function ManageNotifications() {
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://pet-adoption-yc64.onrender.com/api/notification/deleteByIdNotification/${id}`);
      getAllNoti();
    } catch (error) {
      console.log(error);
    }
  ...
  const handleDeleteAll = async () => {
    try {
      await axios.delete(`https://pet-adoption-yc64.onrender.com/api/notification/deleteAllNotification`);
      getAllNoti();
    } catch (error) {
      console.log(error);
    }
